...
namespace Global
{
	...
	const sf::String Config::game_logo_texture_path = "Assets/Textures/duck_hunt_logo.png";
	...
	const sf::String Config::black_duck_texture_path = "Assets/Textures/duck_sprite_sheet.png";
